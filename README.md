...
[![Test](https://github.com/NpoolPlatform/chain-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/chain-gateway/actions/workflows/main.yml)
...
* make chain-gateway ```单独编译服务```
* make chain-gateway-image ```单独生成服务镜像```
